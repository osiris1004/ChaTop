...
public class RentalsController {
    ...
    public ResponseEntity<Rental> saveRental(
        ...
        Rental newRental = new Rental(rental.getName(), rental.getSurface(), attachment.getAttachmentUrl(),
                rental.getPrice(), rental.getDescription(), rental.getOwner_id(), rental.getCreated_at(), attachment);
    ...
    public ResponseEntity<Rental> updateRental(
        ...
        Rental updateRental = new Rental(id, rental.getName(), rental.getSurface(), attachment.getAttachmentUrl(),
                rental.getPrice(), rental.getDescription(), rental.getOwner_id(), rental.getCreated_at(), attachment);
